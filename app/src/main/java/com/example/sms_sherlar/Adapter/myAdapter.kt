package com.example.sms_sherlar.Adapter
...
import com.example.sms_sherlar.Models.Sher
import com.example.sms_sherlar.R
import kotlinx.android.synthetic.main.item_rv.view.*


class SherAdapter(var context: Context, var sherList: List<Sher>, var onMyItemClickListener: OnMyItemClickListener,
                  var like:Int = 0)
...
//            })
    ...
    interface OnMyItemClickListener{
        ...
        //   fun onMyItemLongCLick(sher: Sher)
    }
}